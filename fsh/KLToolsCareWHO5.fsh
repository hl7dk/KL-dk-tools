...
* code = KLCommonCareSocialCodes#e30a95fd-7abd-478b-9a9d-e02dfdd73fd5 "WHO-5 værdi"
* item[0].type = #choice
* item[0].text = "I de sidste 2 uger har jeg været glad og i godt humør"
* item[0].linkId = "1"
* item[0].answerValueSet = "http://kl.dk/fhir/common/caresocial/ValueSet/WHO5AnswerCodes"
...
* item[1].linkId = "2"
* item[1].answerValueSet = "http://kl.dk/fhir/common/caresocial/ValueSet/WHO5AnswerCodes"
...
* item[2].linkId = "3"
* item[2].answerValueSet = "http://kl.dk/fhir/common/caresocial/ValueSet/WHO5AnswerCodes"
...
* item[3].linkId = "4"
* item[3].answerValueSet = "http://kl.dk/fhir/common/caresocial/ValueSet/WHO5AnswerCodes"
...
* item[4].linkId = "5"
* item[4].answerValueSet = "http://kl.dk/fhir/common/caresocial/ValueSet/WHO5AnswerCodes"
...
* questionnaire = "http://kl.dk/fhir/common/caresocial/Questionnaire/WHO-5"
* status = #completed
* subject = Reference(Mark)
* author = Reference(AbrahamFraAkutSygeplejen)
* source = Reference(Mark)
//findinginformerExtension
//methodExtension
